...
interface BurnableERC20 {
	function burn(address, uint256) external returns();
}
...
contract Gravity {
	...
	// Record of how much NOM has been burned
	...
	function sendToCosmos(
		...
		// If token is NOM then burn and update amount burned.
		if (_tokenContract == NOMTokenContract) {
			nc.burn(_amount);
			burnedNOM += _amount;
		}
		state_lastEventNonce = state_lastEventNonce.add(1);
	...
	constructor(
		...
		// Set NOM token contract address
		nc = BurnableERC20(NOMContAddr);
